...
import 'package:flutter_stacked/ui/common/ui_helpers.dart';
import 'package:flutter_stacked/ui/views/text_reverse/text_reverse_view.form.dart';
...
class TextReverseView extends StackedView<TextReverseViewModel>
  ...
  @override
  TextReverseViewModel viewModelBuilder(BuildContext context) {
    return TextReverseViewModel();
  }
